...
var _textTable = __webpack_require__(41);

var _textTable2 = _interopRequireDefault(_textTable);

var _deviceCat = __webpack_require__(62);
...
var _tabBlock = __webpack_require__(111);
...
var _occasions = __webpack_require__(63);

var _occasions2 = _interopRequireDefault(_occasions);

var _priceRange = __webpack_require__(64);

var _priceRange2 = _interopRequireDefault(_priceRange);

var _cities = __webpack_require__(61);

var _cities2 = _interopRequireDefault(_cities);

var _areas = __webpack_require__(60);

var _areas2 = _interopRequireDefault(_areas);

var _spec = __webpack_require__(65);

var _spec2 = _interopRequireDefault(_spec);

var _DeviceCategory = __webpack_require__(108);
...
var _tabTitles = __webpack_require__(114);
...
var _tabTitle = __webpack_require__(113);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_helpers_js__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_filters_currency_js__ = __webpack_require__(42);
...
Vue.component('deviceSearch', __webpack_require__(46));
Vue.component('pagination', __webpack_require__(44));
Vue.component('btnSelector', __webpack_require__(28));
...
Vue.filter('moneyFormat', __WEBPACK_IMPORTED_MODULE_1__components_filters_currency_js__["a" /* default */]);

/** *******************************/
var orderByList = [{ title: '依價格', field: 'price' }, { title: '刊登日期', field: 'created_at' }, { title: '瀏覽人數', field: 'reads' }];
...
var store = new __WEBPACK_IMPORTED_MODULE_2_vuex___default.a.Store(__webpack_require__(45));
...
var vm = new Vue({
    ...
    computed: {
        order_desc: function order_desc() {
    ...
    methods: {
        ...
        toggle_block_view: function toggle_block_view() {
            this.view_control.device_block_view = !this.view_control.device_block_view;
        },
        toggle_order_sequence: function toggle_order_sequence() {
            var newValue = store.state.queryTerm.order_sequence == 'asc' ? 'desc' : 'asc';
        ...
        updateOrderBy: function updateOrderBy(list) {
        ...
        updateQueryTermFromHistory: function updateQueryTermFromHistory() {
            var historyQueryTermObj = JSON.parse(localStorage.getItem(deviceQueryTermKey));
            if (!__WEBPACK_IMPORTED_MODULE_0__components_helpers_js___default.a.isEmpty(historyQueryTermObj)) {
        ...
        updateQueryTermPage: function updateQueryTermPage(searchType, pageOptions) {
        ...
        getQueryList: function getQueryList() {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_0__components_helpers_js___default.a.isEmpty(queryResultHistory)) {
                this.refreshQueryResult(queryResultHistory);
            } else {
                this.ajaxQuery(serializeQueryRequest(store.state.queryTerm));
            }
        },
        doQuery: function doQuery(searchType, pageOptions) {
            if ( searchType === void 0 ) searchType = null;
            if ( pageOptions === void 0 ) pageOptions = null;

            //validate
            if (__WEBPACK_IMPORTED_MODULE_0__components_helpers_js___default.a.isEmpty(searchType)) {
        ...
        ajaxQuery: function ajaxQuery(queryRequest) {
        ...
        refreshQueryResult: function refreshQueryResult(queryResult) {
